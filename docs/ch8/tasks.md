...
- 影响文件: `simplecode/context/manager.py`、`simplecode/context/__init__.py`
- 依赖任务: 无
...
- 影响文件: `simplecode/context/manager.py:14-30, 132-145`
- 依赖任务: 无
...
- 影响文件: `simplecode/context/manager.py:37-58`
- 依赖任务: T1
...
- 影响文件: `simplecode/context/manager.py:59-68`
- 依赖任务: T2
...
- 影响文件: `simplecode/context/manager.py:70-104`
- 依赖任务: T2
...
- 影响文件: `simplecode/context/manager.py:107-127`
- 依赖任务: T2, T4
...
- 影响文件: `simplecode/context/manager.py:148-170`
- 依赖任务: T1
...
- 影响文件: `simplecode/context/manager.py:173-238`
- 依赖任务: T1, T6
- 完成标准:
...
- 影响文件: `simplecode/context/manager.py:241-348`
- 依赖任务: T2, T6, T7
...
- 影响文件: `simplecode/context/manager.py:350-358`
- 依赖任务: T1
...
- 影响文件: `simplecode/context/manager.py:360-419`
- 依赖任务: T1
...
- 影响文件: `simplecode/context/manager.py:421-436`
- 依赖任务: T1
...
- 影响文件: `simplecode/context/manager.py:439-end`
- 依赖任务: T9, T10, T11
...
- 影响文件: `simplecode/client.py:24-68, 138-160`
- 依赖任务: 无
- 完成标准:
...
- 影响文件: `simplecode/agent.py:15-27, 314-316, 436-516, 887-918, 960-1003`
- 依赖任务: T8, T12, T13
- 完成标准:
...
- 影响文件: `simplecode/tools/agent_tool.py:192-203`
- 依赖任务: T3, T14
- 完成标准: 创建 sub_agent 后判断 `p.subagent_type is None`（即真 fork）时 `from simplecode.context import clone_replacement_state` → `sub_agent.replacement_state = clone_replacement_state(self._parent_agent.replacement_state)`。
