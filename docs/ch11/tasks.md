...
- 文件：`mewcode/agent.py`、`mewcode/conversation.py`、`mewcode/prompts.py`
...
- 文件：`mewcode/commands/handlers/skill.py`、`skill_register.py`、
  `mewcode/commands/registry.py`、`clear.py`
...
- 文件：`mewcode/skills/builtins/{commit,review,test}/SKILL.md`、`pyproject.toml`
