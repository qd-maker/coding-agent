...
- 影响文件: `simplecode/agent.py:55-153`
- 依赖任务: 无
...
- 影响文件: `simplecode/agent.py:284-327`
- 依赖任务: T1
...
- 影响文件: `simplecode/agent.py:397-716`
- 依赖任务: T1, T2
...
- 影响文件: `simplecode/agent.py:158-211`
- 依赖任务: T1
...
- 影响文件: `simplecode/agent.py:213-234`
- 依赖任务: T2
...
- 影响文件: `simplecode/agent.py:247-280`
- 依赖任务: T2
...
- 影响文件: `simplecode/agent.py:782-786`
- 依赖任务: T5, T6
...
- 影响文件: `simplecode/agent.py:788-867`
- 依赖任务: T2, T6
...
- 影响文件: `simplecode/agent.py:371-395`、`simplecode/agent.py:603-685`
- 依赖任务: T8
...
- 影响文件: `simplecode/agent.py:329-355`、`simplecode/prompts.py:158-237`
- 依赖任务: 无
...
- 影响文件: `simplecode/tools/task_create.py`、`task_get.py`、`task_list.py`、`task_update.py`
- 依赖任务: 无
...
- 影响文件: `simplecode/agent.py:1105-1117`
- 依赖任务: T2
...
- 影响文件: `simplecode/app.py:649`（构造 `Agent`）、`simplecode/app.py:850-855`（`set_plan_mode`）、`simplecode/app.py:1085`（`async for event in agent.run`）、`simplecode/app.py:1099-1230`（事件分发）、`simplecode/commands/handlers/plan.py`、`simplecode/commands/handlers/do.py`
- 依赖任务: T1~T12
...
- 依赖任务: T13
- 完成标准:
  - `python -m compileall simplecode` 通过（语法 / 导入正确）。
  - `ruff check simplecode tests` 无 error。
