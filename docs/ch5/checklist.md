...
## 3. 编译与测试
- [x] `ruff check simplecode/prompts.py simplecode/teams/coordinator.py simplecode/agent.py tests/test_prompts.py` 通过
- [x] `mypy simplecode/prompts.py simplecode/teams/coordinator.py simplecode/agent.py tests/test_prompts.py` 通过
