...
from simplecode.client import AnthropicClient, AuthenticationError, OpenAIClient
...
def test_missing_environment_api_key_is_authentication_error(
    ...
    monkeypatch.delenv("MISSING_SIMPLECODE_TEST_KEY", raising=False)
    provider = config(protocol, api_key="${MISSING_SIMPLECODE_TEST_KEY}")
