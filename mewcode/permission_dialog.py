...
from mewcode.agent import PermissionRequest, PermissionResponse
from mewcode.tools.ask_user import QuestionItem
...
class InlineQuestionPrompt(Vertical):
    ...
    def _show_current(self) -> None:
        ...
        self.query_one(".inline-prompt-title", Static).update(
            f"MewCode question {self.index + 1}/{len(self.questions)}"
        )
