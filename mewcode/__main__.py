...
from mewcode.agents.tool_filter import TEAMMATE_COORDINATION_TOOLS
from mewcode.app import MewCodeApp
from mewcode.client import AuthenticationError, create_client
...
from mewcode.teams.transcript import save_transcript
from mewcode.tools import ToolRegistry
from mewcode.tools.agent_tool import TEAMMATE_ADDENDUM
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    team_name = os.getenv("MEWCODE_TEAM_NAME") or None
