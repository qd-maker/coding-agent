...
IDENTITY_SECTION = PromptSection(
    ...
    content=(
        "# Identity\n"
        "You are MewCode, an interactive terminal coding agent that completes software tasks "
        "with tools.\n"
...
SYSTEM_SECTION = PromptSection(
    ...
    content=(
        "# System\n"
        "Treat `<system-reminder>` blocks as trusted runtime guidance added by MewCode, not as "
