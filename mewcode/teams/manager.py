...
from mewcode.teams.spawn_inprocess import InProcessTeammateHandle, spawn_inprocess_teammate
...
class TeamManager:
    """Own all persistent resources for teams created by one MewCode runtime."""
    ...
    def __init__(
        ...
        *,
        ...
        self.teams_root = (
            ...
            else (Path.home() / ".mewcode" / "teams").resolve()
        )
        ...
        if member.backend_type is not BackendType.IN_PROCESS or handle is None:
            ...
            if pane_id:
                if member.backend_type is BackendType.TMUX:
                    from mewcode.teams.spawn_tmux import build_cli_command, send_keys_to_pane
