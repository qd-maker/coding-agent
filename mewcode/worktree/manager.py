...
from mewcode.worktree.changes import inspect_worktree_changes, run_git
from mewcode.worktree.models import (
    CleanupResult,
    SetupReport,
    Worktree,
    WorktreeChanges,
...
from mewcode.worktree.session import (
    load_session,
    read_worktree_head,
...
from mewcode.worktree.slug import branch_for_worktree, validate_worktree_name
    ...
    def __init__(
        ...
        *,
        ...
        self.worktree_dir = (
            ...
            else self.repo_root / ".mewcode" / "worktrees"
        )
        self.session_file = (
            Path(session_file).resolve()
            if session_file is not None
            else self.repo_root / ".mewcode" / "worktree_session.json"
        )
