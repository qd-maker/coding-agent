"""Permission modes and their category fallback matrix."""
...
class PermissionMode(str, Enum):  # noqa: UP042 - public contract explicitly requires Enum.
    DEFAULT = "default"
...
_MODE_MATRIX: dict[PermissionMode, dict[ToolCategory, DecisionEffect]] = {
    ...
    PermissionMode.DONT_ASK: {"read": "allow", "write": "deny", "command": "deny"},
}
...
__all__ = ["DecisionEffect", "PermissionMode", "_MODE_MATRIX", "mode_decide"]
