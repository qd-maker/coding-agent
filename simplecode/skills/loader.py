...
PROJECT_SKILLS_DIR = Path(".simplecode/skills")
USER_SKILLS_DIR = Path("~/.simplecode/skills")
...
class SkillLoader:
    def __init__(self, work_dir: str | Path) -> None:
        ...
        self._builtin_dir = Path(str(resources.files("simplecode.skills.builtins"))).resolve()
